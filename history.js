...
function renderRates() {
  ...
  let html = `
    ...
    <div style="display:flex; justify-content:center; gap:16px; margin-bottom:12px; font-size:13px;">
      <span class="color-star3">\u2605 3 \u2014 ${r.star3}.000%</span>
      <span class="color-star2">\u2605 2 \u2014 ${r.star2}.000%</span>
      <span class="color-star1">\u2605 1 \u2014 ${r.star1}.000%</span>
    </div>
    <table class="rates-table">
      <thead><tr><th>レアリティ</th><th>排出率</th><th>対象人数</th><th>個別確率</th></tr></thead>
      <tbody>
        <tr><td class="color-star3">\u2605\u2605\u2605</td><td>${r.star3}.000%</td><td>${s3c}人</td><td>0.138%</td></tr>
        <tr><td class="color-star2">\u2605\u2605</td><td>${r.star2}.000%</td><td>${s2c}人</td><td>0.208%</td></tr>
        <tr><td class="color-star1">\u2605</td><td>${r.star1}.000%</td><td>${s1c}人</td><td>1.517%</td></tr>
      </tbody>
    </table>`;

  // ★3選手一覧
  html += `<div style="margin-top:16px;"><h4 class="color-star3" style="font-size:13px; margin-bottom:8px;">\u2605 3 選手一覧</h4>`;
